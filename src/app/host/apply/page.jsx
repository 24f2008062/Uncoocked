  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        documentUrls: idProofUrl ? { idProofUrl } : null,
      };
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 sm:p-10 max-w-4xl mx-auto space-y-8">
      ...
      <div className="border-b border-neutral-800 pb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Complete your organization profile to publish, manage, and scale events on Uncooked.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between border-b border-neutral-800 pb-4">
        ...
        >
          <span className="w-5 h-5 rounded-full bg-neutral-800 flex items-center justify-center text-[10px]">1</span>
          Organization Info
        </button>
        ...
        >
          <span className="w-5 h-5 rounded-full bg-neutral-800 flex items-center justify-center text-[10px]">2</span>
          Address & Description
        </button>
        <div className="w-8 h-px bg-neutral-800" />
        <button
        ...
        >
          <span className="w-5 h-5 rounded-full bg-neutral-800 flex items-center justify-center text-[10px]">3</span>
          Verification & Review
        </button>
      </div>
        ...
        {step === 1 && (
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-gray-300 uppercase tracking-wider mb-2">
                  Organization Type <span className="text-amber-500">*</span>
                </label>
                <select
            ...
            <div className="flex justify-end pt-4">
              <button
                type="button"
                onClick={() => setStep(2)}
                className="bg-amber-500 hover:bg-amber-400 text-black font-bold text-xs px-6 py-2.5 rounded-lg transition flex items-center gap-2"
              >
        ...
        {step === 2 && (
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-300 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5 text-gray-400" /> Campus Location / Physical Address
                </label>
                <input
                  type="text"
                  value={address}
              ...
              <div>
                <label className="block text-xs font-bold text-gray-300 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  <FileText className="w-3.5 h-3.5 text-gray-400" /> Organization Overview & Past Event Experience
                </label>
                <textarea
                  rows={4}
                  value={description}
            ...
            <div className="flex justify-between pt-4">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="bg-neutral-800 hover:bg-neutral-700 text-gray-300 font-bold text-xs px-5 py-2.5 rounded-lg border border-neutral-700 transition"
              >
                ← Back
              </button>
              <button
        ...
        {step === 3 && (
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-300 uppercase tracking-wider mb-2">
                  Identity Proof / Authorization Link (Drive / Certificate / Government ID URL)
                </label>
                <input
                  type="url"
                  value={idProofUrl}
                ...
                <p className="text-[11px] text-gray-500 mt-1">
                  Provide a link to a student ID, organization registration certificate, or official authorization letter for admin verification.
                </p>
              </div>
              ...
              <div className="bg-black/60 border border-neutral-800 rounded-lg p-4 space-y-3 text-xs">
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-gray-300 truncate">{website || "Not provided"}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between pt-4 border-t border-neutral-800">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-black font-extrabold text-xs px-8 py-3 rounded-lg transition flex items-center gap-2 shadow-lg"
              >
