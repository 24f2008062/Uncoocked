      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <p className="mt-4 text-sm text-gray-400 leading-relaxed">
            Have questions about student events, host sponsorships, or partnership proposals? Drop us a line.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 bg-dark-card p-8 rounded-2xl border border-dark-border shadow-neon">
            <h2 className="text-base font-bold text-white mb-6">Send a Message</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-xs font-semibold text-gray-400">Name</label>
                  <input
                    id="name"
                    required
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-xs font-semibold text-gray-400">Email Address</label>
                  <input
                    id="email"
                    required
                    type="email"
              ...
              <div>
                <label htmlFor="role" className="block text-xs font-semibold text-gray-400">Your Role</label>
                <select
                  id="role"
                  value={role}
              ...
              <div>
                <label htmlFor="message" className="block text-xs font-semibold text-gray-400">Message</label>
                <textarea
                  id="message"
                  required
                  rows={4}
          ...
          <div className="bg-dark-card p-8 rounded-2xl border border-dark-border space-y-6">
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400">📍 Headquarters</h3>
            ...
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400">✉ Email Channels</h3>
              <p className="text-xs text-gray-300 mt-2 space-y-2">
                <span>Support: </span>
                <br />
                <a href="mailto:support@uncooked.edu" className="text-neon-purple hover:underline font-semibold">support@uncooked.edu</a>
                <br />
                <span>Partnerships: </span>
                <br />
                <a href="mailto:sponsors@uncooked.edu" className="text-neon-purple hover:underline font-semibold">sponsors@uncooked.edu</a>
              </p>
            </div>

            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400">⏰ Office Hours</h3>
              <p className="text-xs text-gray-300 mt-2 leading-relaxed">
                Monday – Friday
                <br />
                9:00 AM – 5:00 PM EST
