    ...
    <div className="relative isolate min-h-[85vh] bg-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-dark-card border border-dark-border p-8 rounded-2xl shadow-neon relative">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight">Sign In to Campus OS</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label htmlFor="login-email" className="block text-xs font-semibold text-gray-400">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                <label htmlFor="login-password" className="block text-xs font-semibold text-gray-400">
                  Password
                </label>
                <button
                  type="button"
          ...
          <div className="text-center text-[10px] text-gray-500 font-mono leading-normal pt-2 border-t border-dark-border/40">
            Campus Notice: Enter any mock email and password (4+ chars) to complete local sign-in.
          </div>

          <div className="text-center mt-4">
            <span className="text-xs text-gray-400">Don't have an account? </span>
            <Link href="/signup" className="text-xs text-neon-purple hover:text-neon-lavender font-semibold transition-colors">
              Sign Up
            </Link>
          </div>
        </form>
