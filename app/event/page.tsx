...
import EventsExplorer, { mockEvents, Event as CampusEvent } from '@/app/components/EventsExplorer';
...
export default function EventPage() {
  ...
  const [allEvents, setAllEvents] = useState<(CampusEvent | HostedEvent)[]>(mockEvents);
...
- **🥈 Runner Up**: Custom swag packs & certificate of excellence
        ...
        hostEmail: (selectedEvent as HostedEvent).hostEmail,
      };
