        ...
        <div className="bg-zinc-950/60 border border-white/10 rounded-2xl p-5 sm:p-6 shadow-[0_0_50px_rgba(191,64,255,0.03)] backdrop-blur-xl max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
              ...
              <div className="bg-white/5 border border-white/5 rounded-xl p-5 space-y-4 flex-1">
                <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2 border-b border-white/5 pb-2.5 font-mono">
                  <Calendar className="h-4 w-4 text-neon-purple" /> Attending
                  Events
                </h3>
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="flex items-center justify-between p-3 bg-black/40 border border-white/5 rounded-lg hover:border-neon-purple/20 transition-colors">
                    <div>
                      ...
                      <span className="text-[9px] text-gray-500 mt-1 block">
                        Starts in 3 days ● Venue: Main Arena
                      </span>
                    </div>
                    <span className="text-[9px] bg-green-950/40 text-green-400 border border-green-800/40 px-2.5 py-0.5 rounded-full font-bold">
                      ACTIVE
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-black/40 border border-white/5 rounded-lg hover:border-neon-purple/20 transition-colors">
                    <div>
                      <span className="block text-[11px] font-bold text-white leading-none">
                        Grand Dandiya Festive Night 2026
                      </span>
                      <span className="text-[9px] text-gray-500 mt-1 block">
                        Starts in 28 days ● Venue: Auditorium Hall
                      </span>
                    </div>
                    <span className="text-[9px] bg-zinc-900 text-gray-400 border border-white/10 px-2.5 py-0.5 rounded-full font-bold">
                      UPCOMING
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/5 rounded-xl p-5 space-y-4 flex-1 mt-6">
                <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2 border-b border-white/5 pb-2.5 font-mono">
                  <Radio className="h-4 w-4 text-neon-purple animate-pulse" />{" "}
                  Hosted Operations
                </h3>
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="flex items-center justify-between p-3 bg-black/40 border border-white/5 rounded-lg hover:border-neon-purple/20 transition-colors">
                    <div>
                      ...
                      <span className="text-[9px] text-gray-500 mt-1 block">
                        145 Attendees Registered
                      </span>
                    </div>
                    <span className="text-[9px] bg-neon-purple/10 text-neon-lavender border border-neon-purple/20 px-2.5 py-0.5 rounded-full font-bold">
                      ORGANIZER
                    </span>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
              ...
              <div className="bg-white/5 border border-white/5 rounded-xl p-5 space-y-4 flex-1">
                <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2 border-b border-white/5 pb-2.5 font-mono">
                  <Users className="h-4 w-4 text-neon-purple" /> Live Attendee
                  Guest List
                </h3>
              ...
              <div className="bg-white/5 border border-white/5 rounded-xl p-5 space-y-4 flex-1 mt-6">
                <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2 border-b border-white/5 pb-2.5 font-mono">
                  <Send className="h-4 w-4 text-neon-purple" /> Broadcast
                  Composer
                </h3>
                ...
                <div className="space-y-3 text-xs font-mono">
                  ...
                  >
                    <CheckCircle className="h-3.5 w-3.5" /> Publish Broadcast
                    Log
                  </button>
                </div>
              </div>
