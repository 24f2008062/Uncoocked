...
export default function Hero() {
  return (
    <section className="relative overflow-hidden w-full py-16 sm:py-24">
      ...
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#0f0f15_1px,transparent_1px),linear-gradient(to_bottom,#0f0f15_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-70" />
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              ...
              <p className="text-base sm:text-lg leading-relaxed text-gray-400 max-w-2xl mx-auto lg:mx-0">
                Join campus fests, discover workshops and dandiya nights, coordinate in noise-free channels, and book tickets instantly from a single unified workspace.
              </p>
            </motion.div>
            ...
            >
              <Link
                href="/event"
                className="w-full sm:w-auto text-center rounded-full bg-neon-purple text-white px-8 py-4 text-xs font-extrabold tracking-wider uppercase shadow-neon hover:bg-neon-purple/90 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                Explore Events
              </Link>
              <Link
            ...
            >
              <div>
                <span className="block text-white font-extrabold text-lg"><CountUp end={8900} suffix="+" /></span>
                Registrations
              </div>
              <div className="w-[1px] bg-white/10 self-stretch" />
              <div>
                <span className="block text-white font-extrabold text-lg"><CountUp end={1200} suffix="+" /></span>
                Students Active
              </div>
              <div className="w-[1px] bg-white/10 self-stretch" />
              <div>
                <span className="block text-white font-extrabold text-lg"><CountUp end={50} suffix="+" /></span>
                Campus Events
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-center pb-3 border-b border-white/5">
                  ...
                  <span className="text-gray-500 font-bold uppercase tracking-widest text-[8px]">CAMPUS_CONSOLE_v1.0</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-white/5 border border-white/5 rounded-xl p-3.5 space-y-1 hover:border-neon-purple/30 transition-colors">
                    ...
                    <div className="text-base font-black text-white"><CountUp end={482} /> <span className="text-[8px] text-green-400 font-normal">● LIVE</span></div>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/5 rounded-xl p-3.5 space-y-1 hover:border-neon-purple/30 transition-colors">
                    ...
                    <div className="text-base font-black text-white"><CountUp end={12} /> <span className="text-[8px] text-gray-400 font-normal">RUNNING</span></div>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/5 rounded-xl p-3.5 space-y-1 hover:border-neon-purple/30 transition-colors">
                    ...
                    <div className="text-base font-black text-white"><CountUp end={34} /> <span className="text-[8px] text-neon-lavender font-normal">ACTIVE</span></div>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/5 rounded-xl p-3.5 space-y-1 hover:border-neon-purple/30 transition-colors">
                    ...
                    <div className="text-base font-black text-white"><CountUp end={2842} /> <span className="text-[8px] text-neon-purple font-normal">TOTAL</span></div>
                  </div>
                </div>
                ...
                <div className="bg-black/60 border border-white/5 rounded-xl p-3.5 h-24 overflow-hidden flex flex-col justify-end space-y-1 text-gray-400">
                  <div className="text-neon-lavender">&gt;&gt; Loading campus sync pipeline...</div>
                  <div>&gt;&gt; 👤 student_mikey registered for Dandiya Night</div>
                  <div>&gt;&gt; 🚀 Cultural Club registered Annual Fest</div>
                  <div className="text-green-400">&gt;&gt; ✓ Synchronization successful. State persisted.</div>
                </div>
              </motion.div>
            </motion.div>
          </div>
