...
const categories = [
  {
    ...
    name: "All",
    description:
      "Browse all active events, coding sprints, sports leagues, and volunteer drives in one dashboard.",
  },
  {
    id: "tech-builder",
    name: "Hackathons",
    description:
      "Robotics Showdowns, Web3 Sprints, Open-Source Contributions, and Cyber Security CTFs",
  },
  {
    id: "global-affairs",
    name: "Model United Nations (MUNs)",
    description:
      "Parliamentary Debates, Youth Parliaments, and Elocution Tracks",
  },
  {
    id: "corporate-venture",
    name: "Ideathons",
    description:
      "Business Plan Sprints, Case Study Face-offs, Stock Trading Simulations, and E-Cell Initiatives",
  },
  {
    id: "athletics-field",
    name: "Inter-college Cricket Leagues",
    description:
      "Basketball Tournaments, Football Championships, and Esports Showdowns",
  },
  {
    id: "creative-literary",
    name: "Creative Writing Competitions",
    description:
      "Poetry Slams, Journalism Bootcamps, and Fine Arts Exhibitions",
  },
  {
  ...
  },
  {
    ...
    description:
      "Fellowships, Part-Time Corporate Sprints, and Freelance Gig Pools",
  },
  {
    id: "social-impact",
    name: "NGO Volunteer Drives",
    description:
      "Sustainability Initiatives, Battle of the Bands, and Street Plays",
  },
];
...
const eventItems = [
  ...
  },
  {
    ...
    summary:
      "Debate public policy, represent country cabinets, and draft legislative bills.",
    detailLink: "/event",
  },
  {
    id: "ev-ideathon",
    ...
    summary:
      "Pitch startup business models directly to early-stage venture fund managers.",
    detailLink: "/event",
  },
  {
    id: "ev-cricket",
    ...
    summary:
      "Represent your college in the annual knockout campus cricket tournament.",
    detailLink: "/event",
  },
  {
    id: "ev-writing",
    ...
    summary:
      "Showcase fine arts and journalism write-ups before a panel of literary judges.",
    detailLink: "/event",
  },
  {
    id: "ev-cooking",
    ...
    summary:
      "Present hospitality menus and baking creations in live mixology battles.",
    detailLink: "/event",
  },
  {
    id: "ev-chat-lobby",
    ...
    summary:
      "Coordinate with fellow campus students, share social updates, and form groups in the chat lobby.",
    detailLink: "/chat",
  },
  {
    id: "ev-volunteer",
    ...
    summary:
      "Join NGO local initiatives, battle of the bands, and street play coordinates.",
    detailLink: "/event",
  },
];
                    ...
                    <button
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "ArrowRight") {
                          const next =
                            filteredCategories[
                              (idx + 1) % filteredCategories.length
                            ];
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            {filteredEvents.length === 0 ? (
              <p className="text-xs text-gray-500 py-8">
                No campus events match your selection.
              </p>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mt-8">
                {filteredEvents.map((item) => (
                  <div
                    key={item.id}
                    className="bg-dark-card rounded-lg p-6 border border-dark-border hover:border-neon-purple/30 transition-all duration-300 flex flex-col justify-between h-56"
                  >
