      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Empowering campus students and event organizers with zero-noise event coordination and ticketing tools.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href={user ? "/dashboard" : "/"} className="text-gray-400 hover:text-neon-purple transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/event" className="text-gray-400 hover:text-neon-purple transition-colors">
                  Browse Events
                </Link>
              </li>
              <li>
                <Link href="/opportunities" className="text-gray-400 hover:text-neon-purple transition-colors">
                  Opportunities
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-neon-purple transition-colors">
                  Contact Support
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-dark-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="hover:text-neon-purple transition-colors">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
