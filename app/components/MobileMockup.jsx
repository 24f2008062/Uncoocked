        ...
        <div className="space-y-3 mt-4">
          <div className="bg-dark-card border border-dark-border rounded-xl p-3.5 space-y-2.5 shadow-sm">
            <div className="flex justify-between items-center">
              <span className="text-[8px] font-bold uppercase tracking-wider px-2 py-0.5 bg-neon-purple/20 text-neon-lavender rounded">
                Cultural Fest
              </span>
            ...
            <div className="flex justify-between text-[8px] text-gray-500">
              ...
              <span className="text-neon-lavender font-bold">
                1,200 Attending
              </span>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex-1 bg-black/60 p-2 rounded-lg border border-dark-border">
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-[8px] font-bold text-neon-purple block">
                      Frontend Intern
                    </span>
        ...
        <div className="mt-4 mb-6">
          <div className="bg-dark-card border border-dark-border rounded-xl p-3 flex justify-around items-center text-center shadow-sm">
            <div>
              ...
              <div className="text-sm font-black text-neon-purple leading-tight mt-0.5">
                Instant
              </div>
            </div>
