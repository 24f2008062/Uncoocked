    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm mx-auto animate-fadeIn">
        ...
        <div className="bg-neon-purple text-white p-4 rounded-t-2xl relative overflow-hidden flex items-center justify-between shadow-[0_0_40px_rgba(191,64,255,0.4)]">
          <div>
            <span className="text-[10px] font-black tracking-widest uppercase opacity-80 block">Admit One</span>
            <span className="text-xl font-black uppercase tracking-wider">{ticketType} Ticket</span>
          </div>
        ...
        <div className="bg-zinc-950 border-x border-b border-dark-border p-6 rounded-b-2xl relative shadow-neon-thick">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <span className="text-[9px] text-gray-500 uppercase tracking-widest font-bold block mb-1">Attendee</span>
                <span className="text-xs text-white font-mono truncate block" title={attendeeName}>{attendeeName}</span>
              </div>
              <div>
                <span className="text-[9px] text-gray-500 uppercase tracking-widest font-bold block mb-1">Ticket ID</span>
