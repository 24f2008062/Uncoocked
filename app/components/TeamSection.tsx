    ...
    <section className="w-full py-16 bg-black border-t border-dark-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="space-y-4 text-center">
          <span className="text-xs font-extrabold text-neon-purple tracking-widest uppercase block neon-text-glow">Our Operations</span>
          <h2 className="text-3xl font-black text-white">The Core Team</h2>
          <p className="text-xs text-gray-400 max-w-2xl mx-auto">
            The developers and product architects coordinating student engagement across the campus network.
          </p>
        </div>
          ...
          {members.map((m, idx) => (
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="text-sm font-bold text-white group-hover:text-neon-purple transition-colors">{m.name}</h4>
                <p className="text-[10px] text-gray-500 font-semibold">{m.role}</p>
              </div>
