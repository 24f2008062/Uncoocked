...
export default function BulletinFeed() {
  const items = [
    {
      text: "🤖 AI & LLM Workshop: Student check-in opens in 1 hour",
      time: "Just now",
      type: "system",
    },
    {
      text: "🤝 Dandiya Festive Night: Entry gates open at 6:00 PM",
      time: "12m ago",
      type: "event",
    },
    {
      text: "🚀 Cultural Fest: Stage rehearsals scheduled for Main Arena",
      time: "35m ago",
      type: "active",
    },
    {
      text: "📚 Founder Meetup: Networking session registrations closing soon",
      time: "1h ago",
      type: "system",
    },
    {
      text: "🏆 Awards Room: Cultural Fest contest winner guest list posted",
      time: "2h ago",
      type: "event",
    },
  ];
              ...
              {duplicatedItems.map((item, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300 tracking-tight leading-relaxed">
                      {item.text}
                    </span>
                  </div>
                  <span className="text-[9px] text-gray-500 shrink-0 font-bold uppercase">
                    {item.time}
                  </span>
                </div>
              ))}
